...
//Class responsibly for displaying courses 'Θεωρητικής Πληροφορικής'
public class Fragment2_Th extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {		
		String select = "SELECT ThP, Name, Description, Grade FROM Subjects WHERE  Code LIKE 'ΘΠ%' AND Selected=1 ORDER BY Thp ";
		String select2 = "SELECT ThP, Name, Description FROM Subjects WHERE  Code LIKE 'ΘΠ%' AND Selected=0 ORDER BY Thp";
