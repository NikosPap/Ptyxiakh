...
public class Fragment1_K extends ListFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {		
		String select = "SELECT Name, Description, Grade FROM Subjects WHERE  Code LIKE 'Κ%' AND Selected=1";
		String select2 = "SELECT Name, Description FROM Subjects WHERE  Code LIKE 'Κ%' AND Selected=0";
		...
		if(cursor2.moveToFirst()){
			do{
				subjects.add(new CourseItem(cursor2.getString(0),false,cursor2.getString(1)));
