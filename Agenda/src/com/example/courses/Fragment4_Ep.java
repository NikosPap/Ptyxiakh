...
//Class responsibly for displaying courses 'Επιλογής'
public class Fragment4_Ep extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {		
		String select = "SELECT EP, Name, Description, Grade FROM Subjects WHERE  Code LIKE 'ΕΠ%' AND Selected=1 ORDER BY EP ";
		String select2 = "SELECT EP, Name, Description FROM Subjects WHERE  Code LIKE 'ΕΠ%' AND Selected=0 ORDER BY EP";
		...
		//View view = inflater.inflate(R.layout.courses_ep, container, false);
		...
		return (LinearLayout)inflater.inflate(R.layout.courses_ep, container, false);
	}
